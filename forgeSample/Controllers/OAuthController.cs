    ...
    public class OAuthController : ControllerBase
    {
        ...
        public string GetOAuthURL()
        {
            ...
            string oauthUrl = _threeLeggedApi.Authorize(
              ...
              new Scope[] { Scope.AccountWrite, Scope.AccountRead, Scope.DataRead, Scope.DataCreate, Scope.DataWrite, Scope.ViewablesRead });
    ...
    public class Credentials
    {
        ...
        private async Task RefreshAsync()
        {
            ...
            dynamic credentialInternal = await oauth.RefreshtokenAsync(
              GetAppSetting("FORGE_CLIENT_ID"), GetAppSetting("FORGE_CLIENT_SECRET"),
              "refresh_token", RefreshToken, new Scope[] { Scope.AccountWrite, Scope.AccountRead, Scope.DataRead, Scope.DataCreate, Scope.DataWrite, Scope.ViewablesRead });
